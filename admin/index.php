    ...
    <div class="admin-main">
        ...
        <div class="admin-stats">
            <div class="admin-stat-card">
                ...
                <div class="admin-stat-card__body">
                    <p class="admin-stat-card__label">Toplam Kullanıcı</p>
            ...
            <div class="admin-stat-card">
                ...
                <div class="admin-stat-card__body">
                    <p class="admin-stat-card__label">Ürünler</p>
            ...
            <div class="admin-stat-card">
                ...
                <div class="admin-stat-card__body">
                    <p class="admin-stat-card__label">Siparişler</p>
            ...
            <div class="admin-stat-card">
                ...
                <div class="admin-stat-card__body">
                    <p class="admin-stat-card__label">Gelir</p>
        ...
        <div class="admin-card">
            <div class="admin-card__header">
                ...
                <a href="<?= SITE_URL ?>/admin/orders.php" class="btn btn--secondary btn--sm">Tümünü Gör</a>
            </div>
            <div class="admin-table-wrap">
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        <tr><td colspan="5" class="admin-table__empty">Henüz sipariş yok.</td></tr>
                        <?php else: ?>
