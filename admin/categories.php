...
<div class="admin-layout">
    ...
    <div class="admin-main">
        <div class="admin-topbar">
            <h1 class="admin-page-title">Kategoriler</h1>
        </div>
        ...
        <div class="admin-card">
            <div class="admin-card__header">
                <h2 class="admin-card__title"><?= $editCat ? 'Kategoriyi Düzenle' : 'Kategori Ekle' ?></h2>
                <?php if ($editCat): ?>
                    <a href="<?= SITE_URL ?>/admin/categories.php" class="btn btn--secondary btn--sm">İptal</a>
                <?php endif; ?>
            </div>
            <form method="POST" action="" class="admin-form">
                ...
                <button type="submit" class="btn btn--primary">
                    <?= $editCat ? 'Kategoriyi Güncelle' : 'Kategori Ekle' ?>
                </button>
            </form>
        </div>
        ...
        <div class="admin-card">
            <div class="admin-card__header">
                <h2 class="admin-card__title">Tüm Kategoriler</h2>
            </div>
            <div class="admin-table-wrap">
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        <tr><td colspan="4" class="admin-table__empty">Henüz kategori yok.</td></tr>
                        <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="admin-table__actions">
                                <a href="?action=edit&id=<?= $cat['id'] ?>" class="btn btn--secondary btn--sm">Düzenle</a>
                                <form method="POST" action="" style="display:inline"
                                      onsubmit="return confirm('Bu kategori silinsin mi? Ürünler kategorisiz kalacak.')">
                                    <input type="hidden" name="csrf_token" value="<?= $csrf ?>">
