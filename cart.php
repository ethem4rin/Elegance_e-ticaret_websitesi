...
<div class="container">
    ...
    <div class="empty-state empty-state--cart">
        ...
        <h2>Sepetiniz boş</h2>
        <p>Koleksiyonumuzu keşfedin ve favori parçalarınızı ekleyin.</p>
        <a href="<?= SITE_URL ?>/products.php" class="btn btn--primary">Hemen Alışveriş Yap</a>
    </div>
    ...
    <div class="cart-layout">
        ...
        <aside class="cart-summary">
            <div class="cart-summary__card">
                <h2 class="cart-summary__title">Sipariş Özeti</h2>
                ...
                <div class="cart-summary__row">
                    <span>Kargo</span>
                    <span class="cart-summary__shipping"><?= $total >= 150 ? 'Ücretsiz' : '₺9.99' ?></span>
                </div>
