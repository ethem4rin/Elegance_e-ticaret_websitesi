...
if ($id <= 0) {
    ...
    echo '<div class="container" style="padding:80px 20px;text-align:center;"><h2>Ürün Bulunamadı</h2><a href="' . SITE_URL . '/products.php" class="btn btn--primary" style="margin-top:20px;">Mağazaya Dön</a></div>';
...
<div class="container">
    ...
    <nav class="breadcrumb" aria-label="Breadcrumb">
        ...
        <a href="<?= SITE_URL ?>/products.php">Mağaza</a>
        ...
        <div class="product-detail__info">
            ...
            <div class="product-detail__stock">
                <?php if ($product['stock_quantity'] > 0): ?>
                    <span class="stock-badge stock-badge--in">Stokta (<?= $product['stock_quantity'] ?> adet)</span>
                <?php else: ?>
                    <span class="stock-badge stock-badge--out">Stokta Yok</span>
                <?php endif; ?>
            </div>
            ...
            <div class="product-detail__add">
                <div class="quantity-selector">
                    <button type="button" class="qty-btn qty-btn--minus" aria-label="Adedi azalt">−</button>
                    <input type="number" class="qty-input" id="qty-input" value="1"
                           min="1" max="<?= $product['stock_quantity'] ?>" readonly>
                    <button type="button" class="qty-btn qty-btn--plus" aria-label="Adedi artır">+</button>
                </div>
